...
<head>
	<meta charset="UTF-8">
	<title>Welcome to CodeIgniter 4! - exam</title>
...
<body>
	...
	<header>
		...
		<div class="menu">
			<ul>
				...
				<li class="menu-item hidden"><a href="/history">History</a>
				</li>
			</ul>
		</div>
	...
	<section id="app">
		...
		<h1>ย่อ URL</h1>
		<div>
			<b-form v-if="url_short == null">
				<b-form-group id="input-group-1" label="URL:" label-for="input-1" description="กรุณาใส่ URL สำหรับ ย่อ">
					<b-form-input id="input-1" v-model="url" type="text" placeholder="Enter url" :state="validateState('url')"></b-form-input>
				</b-form-group>
			...
			<b-form v-if="url_short !== null">
				<b-form-group id="input-group-1" label="URL:" label-for="input-1" description="กรุณาใส่ URL สำหรับ ย่อ">
					<b-form-input id="input-1" v-model="url" type="text" placeholder="Enter url" size="lg" disabled></b-form-input>
				</b-form-group>
				<b-form-group prepend="Username" class="mt-3" id="input-group-1" label="Short URL:" label-for="input-1" description="Short URL">
					
					
					<b-input-group  class="mt-3">
					
					<b-form-input id="input-1" v-model="url_short" type="text" placeholder="Enter url" size="lg" disabled></b-form-input>
					<b-input-group-append>
						<b-button v-clipboard:copy="url_short" size="lg" variant="outline-success">Copy</b-button>
					</b-input-group-append>
				</b-input-group>
				</b-form-group>
				<b-button @click="newForm" variant="danger">New</b-button>
				<img :src="url_qrcode">
			</b-form>
	...
	<script src="/vue-clipboard2/dist/vue-clipboard.min.js"></script>
